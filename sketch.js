...
ciclistaPrincipal.setCollider("rectangle" ,30,30,60,60);
...
function draw() {
  ...
  textSize(20)
  fill(255)
  text("Pressione a tecla 🡅 para recomeçar o jogo" , 500,250);
...
function reset(){
  estadoJogo = JOGAR;
  fimdeJogo.visible = false;
  ciclistaPrincipal.addAnimation("SahilRunning", imgCiclistaPrincipal);
  
ciclistaRosa.destroyEach();
ciclistaAmarelo . destroyEach();
ciclistaVermelho.destroyEach();
